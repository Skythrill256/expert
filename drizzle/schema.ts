...
export const shareLinks = sqliteTable("share_links", {
	...
	revoked: integer().default(false).notNull(),
...
export const userSettings = sqliteTable("user_settings", {
	...
	weeklyReports: integer("weekly_reports").default(true).notNull(),
	recommendationsNotifications: integer("recommendations_notifications").default(true).notNull(),
	createdAt: integer("created_at").notNull(),
	updatedAt: integer("updated_at").notNull(),
});
...
export const userProfile = sqliteTable("user_profile", {
	...
	onboardingCompleted: integer("onboarding_completed").default(false).notNull(),
